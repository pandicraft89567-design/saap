        ...
        const embeds = {
            entretenimiento: new EmbedBuilder()
                ...
                .addFields(
                    ...
                    { name: '😂 Chiste',           value: m('chiste'),   inline: true }
                ),
            ...
            utils: new EmbedBuilder()
                ...
                .addFields(
                    ...
                    { name: '🔄 Auto-traducción',  value: m('traduccion'),   inline: true },
            ...
            mod: new EmbedBuilder()
                ...
                .addFields(
                    ...
                    { name: '🛡️ Anti-Raid',       value: m('antiraid'),   inline: true },
                    { name: '🔧 Discord Mod',     value: m('discordmod'), inline: true },
