...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .setDescriptionLocalizations({ 'en-US': 'Shows all available bot commands', 'en-GB': 'Shows all available bot commands' }),
    alias: 'help',
        ...
        const embeds = {
            ...
            social: new EmbedBuilder()
                ...
                .addFields(
                    ...
                    { name: '👋 Castigar',        value: m('castigar'),             inline: true },
            ...
            utils: new EmbedBuilder()
                ...
                .addFields(
                    ...
                    { name: '👋 Config bienvenida',value: m('welcomeset'),   inline: true },
                    { name: '📝 Personalizar bienvenida', value: m('welcomeconfig'), inline: true },
                    { name: '🧪 Test bienvenida',  value: m('welcometest'),  inline: true },
