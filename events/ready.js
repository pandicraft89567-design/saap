...
const { ensureAutoModRulesAllGuilds } = require('../utils/autoModSetup');
...
module.exports = {
    ...
    async execute(client) {
        ...
        // Asegurar reglas nativas de AutoMod en todos los servidores (badge de AutoMod)
        ensureAutoModRulesAllGuilds(client).catch(err =>
            console.error('❌ Error sincronizando AutoMod:', err)
        );
