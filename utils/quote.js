...
const STYLES = {
    dark:   { bg1: '#0d1117', bg2: '#161b22', accent: '#58a6ff', textColor: '#e6edf3', label: '🌑 Oscuro'  },
    purple: { bg1: '#0e0720', bg2: '#1a0f35', accent: '#bf91f7', textColor: '#e9d8ff', label: '💜 Violeta' },
    ocean:  { bg1: '#071428', bg2: '#0d2040', accent: '#00d4ff', textColor: '#cef4ff', label: '🌊 Océano'  },
    sepia:  { bg1: '#1a1008', bg2: '#2a1c0e', accent: '#e0a060', textColor: '#f5e0c0', label: '📜 Sépia'   },
    rose:   { bg1: '#1a0814', bg2: '#2d1020', accent: '#ff5fa0', textColor: '#ffe0ef', label: '🌹 Rosa'    },
};
